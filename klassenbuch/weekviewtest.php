...
<head>
    ...
    <!-- Hier noch ein wichtiger Kommentar -->
    <!-- Bootstrap CSS -->
            ...
            <div class="m-3 p-3 row bg-dark">
                <div class="input-group input-group-sm col-md">
                    <div class="input-group-prepend">
                        <input type="radio" class="btn-check" name="options-auswahl" id="gruppe-auswahl" autocomplete="off">
                        <label class="btn btn-outline-primary" for="gruppe-auswahl" data-bs-toggle="tooltip" data-bs-placement="top" title="Übersicht nach Klasse / Kurs">
                ...
                <div class="input-group input-group-sm col-md">
                    <div class="input-group-prepend">
                        <input type="radio" class="btn-check" name="options-auswahl" id="lehrer-auswahl" autocomplete="off" checked>
                        <label class="btn btn-outline-primary" for="lehrer-auswahl" data-bs-toggle="tooltip" data-bs-placement="top" title="Übersicht nach Lehrer / Lehrerin">
                            Lehrer <i class="bi-person px-2"></i>
                        </label>
                    </div>
                    <select class="form-control" name="lehrer" id="lehrer" data-bs-toggle="tooltip" data-bs-placement="top" title="Wähle einen Lehrer / eine Lehrerin"></select>
                    <button type="button" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="top" title="Ich" id="ich_btn">
                            ...
                            <form class="row m-3 p-3 bg-dark needs-validation" novalidate>
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-group col-md" data-bs-toggle="tooltip" data-bs-placement="top" title="Wähle das Datum des Unterrichts">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                                                <!-- Datum -->
                                                <i class="bi-calendar-date px-2"></i>
                                            </span>
                                        </div>
                                    ...
                                    <div class="col-3">
                                        <div class="input-group" data-bs-toggle="tooltip" data-bs-placement="top" title="Hier kann angegeben werden, dass ein Vertretungsunterricht stattgefunden hat">
                                            <div class="input-group-text">
                                                <input class="form-check-input mt-0" type="checkbox" value="" aria-label="Checkbox for following text input" name="vertretung" id="vertretung">
                                            </div>
                                    ...
                                    <div class="col-6">
                                        <div class="input-group" data-bs-toggle="tooltip" data-bs-placement="top" title="Wähle einen Sitzplan">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">
                                                    <!-- Sitzplan -->
                                                    <i class="bi-grid-3x2-gap px-2"></i>
                                                </span>
                                            </div>
                                ...
                                <div class="row py-2">
                                    <div class="input-group">
                                        ...
                                        <textarea id="inhalte" name="inhalte" rows="4" cols="30" placeholder="Inhalt der Stunde" class="form-control"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row py-2">
                                    <div class="input-group">
                                        ...
                                        <textarea id="bemerkungen" name="bemerkungen" rows="4" cols="30" placeholder="Bemerkungen zur Stunde" class="form-control"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row py-2">
                                    <div class="col-9">
                                        <div class="input-group">
                                            ...
                                            <textarea id="aufgaben" name="aufgaben" rows="4" cols="30" placeholder="Aufgaben aus der Stunde" class="form-control"></textarea>
                                        </div>
                                    </div>
                                ...
                                <div id="Anwesenheit">
                                    <div class="row m-3 py-2 bg-dark border">
                                        <div class="col-2 ">
                                            <button class="btn btn-secondary mr-2" type="button" id="alle_praesent"><i class="bi-emoji-smile px-2"></i>alle anwesend</button>
                                        </div>
                                        <div class="col-10">
                                            <div id="praesenzen">
                                            </div>
    ...
    <script>
        ...
        function label_timetable() {
            ...
            $("#cancel").click(function() {
                $("#unterricht").modal('hide');
            }); //Änderung UL Modal, vorher: $("#unterricht").hide();
            $("#sitzplanzeigen").click(function() {
                sitzplananzeigen();
            });
